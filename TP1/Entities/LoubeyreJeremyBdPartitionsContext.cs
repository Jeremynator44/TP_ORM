...
public partial class LoubeyreJeremyBdPartitionsContext : DbContext
{
    public LoubeyreJeremyBdPartitionsContext()
    {
    }

    public LoubeyreJeremyBdPartitionsContext(DbContextOptions<LoubeyreJeremyBdPartitionsContext> options)
        : base(options)
    {
    }
